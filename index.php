        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" data-spy="affix" data-offset-top="50">
            <div class="container">
                ...
                <div class="navbar-header col-md-3">
                    ...
                    <a class="navbar-brand" href="#home"> FSDHC</a>
                </div>
...
<section id="inicio">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <img class="col-md-12 col-sm-12 col-xs-12 animated fadeInDown logo-topo" src="assets/img/logo forum 2.png" alt="Logo FSDHC">
                <h1 class="title col-md-12 col-sm-12 col-xs-12">FSDHC</h1>
                <h2 class="subtitle col-md-12 col-sm-12 col-xs-12">Fórum Social de Direitos Humanos e Cidadania</h2>
            </div>
            <div class="col-md-12">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="portfolio-item wow fadeInLeft atividades" data-wow-delay=".5s">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="portfolio-item wow fadeInLeft atividades" data-wow-delay=".7s">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="portfolio-item wow fadeInLeft atividades" data-wow-delay=".9s">
    ...
    <section id="quem_somos">
        <div class="container">
            <div class="row">
                ...
                <h2 class="subtitle">Conheça mais nosso trabalho, metas, politica e ideais</h2>
